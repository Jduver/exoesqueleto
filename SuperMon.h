...
<title>Web Page Update Demo</title>
  ...
  <script type = "text/javascript">
    ...
    var posMotor;
    function actualizar_pos_motor(pos_motor){
        posMotor=pos_motor;
        return posMotor;
    }
    var input_pos_motor;
    function actualizar_axis(input_pos){
        input_pos_motor=input_pos;
        return input_pos_motor;
    }
    ...
    function response(){
      ...
      message = (xmldoc[0].firstChild.nodeValue)/100;

      actualizar_pos_motor(message);
    ...
    //*******************************************************
      ...
      setInterval(function(){
          ...
          Plotly.extendTraces('chart',{ y:[[input_pos_motor]]},[0]);
          Plotly.extendTraces('chart',{ y:[[posMotor]]},[1]);
          cnt++;
          if(cnt > 500) {
